...
export default function Pokedex () {
  ...
  const [name, setName] = useState<string>("chikorita");
      ...
      <div className="pokedex-left">
        ...
        <div className="pokedex-left-bottom">
          ...
          <PokemonForm 
            ...
            pokemon={name}
            setPokemon={handleInputChange}
          />
        </div>
      </div>
      <div className="pokedex-right-front" />
      <div className="pokedex-right-back" />
      <button onClick={SERVICE.signInWithGitHub}>Login with GitHub</button>
      <button 
        onClick={async () =>{
          const user = await SERVICE.getCurrentUser();
          console.log("dd",user)
        }}>Mostrar Usuario</button>
      <button onClick={SERVICE.signOut}>Logout</button>
    </div>
    )
}